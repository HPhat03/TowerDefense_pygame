...
class Game(Scene):
    ...
    PlayBt = Button(setting.WINDOW_WIDTH - 120, setting.WINDOW_HEIGHT - 60,
    ...
    def game(screen, login):
        ...
        if not Game.isEnabled:
            ...
            Game.PlayBt.background_color = setting.button_color
            Game.PlayBt.text = "Play"
        Game.PlayBt.rect.width = Game.PlayBt.text_rect.width + 20
        Game.PlayBt.rect.left = setting.WINDOW_WIDTH - \
