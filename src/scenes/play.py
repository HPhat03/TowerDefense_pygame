...
class Play(Scene):
    ...
    container = ControlsContainer(setting.WINDOW_WIDTH - 300, 0, teamTowers,
    ...
    upgradePanel = ControlsContainer(setting.WINDOW_WIDTH - 300,
                                     container.rect.height, UGPs,
                                     10, (113, 112, 113))

    statePs = pg.sprite.Group()
    waveLabel = Label(10, 60, 150, 50, "Wave 0", color="white")
    MaxHPBar = Label(10, 10, setting.WINDOW_WIDTH - 30 - 300, 50, "", "red",
                     border_radius=10)
    CurHPBar = Label(10, 10, setting.WINDOW_WIDTH - 30 - 300, 50, "", "green",
                     border_radius=10)
    statePs.add(MaxHPBar, waveLabel, CurHPBar)
    statePanel = ControlsContainer(0, setting.WINDOW_HEIGHT - 130, statePs,
                                   10, (113, 112, 113))
    BudgetLabel = Label(setting.WINDOW_WIDTH + 50 - 300,
                        setting.WINDOW_HEIGHT + 10 - 130,
